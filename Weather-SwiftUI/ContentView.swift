    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                ...
                HStack(spacing:20){
                     WeatherDayView(dayOfWeek: "TUE", imageName: "cloud.bolt.rain.fill", temperature: 74)
                    
                     WeatherDayView(dayOfWeek: "WED", imageName: "cloud.sun.rain.fill", temperature: 74)
                    
                    WeatherDayView(dayOfWeek: "THU", imageName: "cloud.rain.fill", temperature: 74)
                     
                    WeatherDayView(dayOfWeek: "FRI", imageName: "sun.max.fill", temperature: 74)
                    
                    WeatherDayView(dayOfWeek: "SAT", imageName: "cloud.sleet.fill", temperature: 74)
                }
                Spacer()
